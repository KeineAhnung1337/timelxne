...
- Keep the public API in `bundles/dev.timelxne.timeline` and implementation details in its
  `internal` package.
...
- `bundles/` contains production OSGi bundles.
- `examples/` contains runnable demonstration applications.
- `features/` contains installable PDE features.
- `tests/` contains test fragments and performance checks.
- `releng/` contains target-platform and distribution projects.
